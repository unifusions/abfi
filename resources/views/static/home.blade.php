<x-web-layout>
    ...
    <x-slot:title>
        Amateur Baseball Federation of India Official Website
        </x-slot>
        <!-- Hero Section -->
        <section class="relative h-[600px] w-full overflow-hidden">
            ...
            <div
                ...
                <h1 class="font-display-lg text-display-lg mb-6 max-w-2xl leading-tight">Official Home of Indian
                    Baseball
                </h1>
                <p class="font-body-lg text-body-lg max-w-xl mb-8 opacity-90">Governing and promoting the spirit of
                    baseball
        ...
        <section class="py-section-padding bg-surface-bright">
            <div class="max-w-container-max mx-auto px-margin-desktop">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-gutter">
                    <!-- Main History Card -->
                    <div
                        class="md:col-span-8 bg-surface-container-low p-10 rounded-xl border border-outline-variant/30">
                        ...
                        <div class="prose max-w-none text-on-surface-variant leading-relaxed font-body-md space-y-4">
                            <p>The Federation was established in December 1983 with an object to promote this game. On
                                11th
                                December 1983 some Baseball lovers from Delhi, Manjpur, Haryana, Gujarat, M.P and West
                                Bengal met at Rohtak (Haryana) and agreed to form a baseball federation to promote
                                baseball
                                game through out the country.</p>
                            <p>The Baseball Leaders also agreed that the Federation should become a member of Asian
                                baseball
                    ...
                    <div class="md:col-span-4 space-y-gutter">
                        ...
                        <div class="bg-tertiary text-on-tertiary p-8 rounded-xl flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-label-sm text-label-sm uppercase tracking-widest opacity-70">Downloads
                                </p>
            ...
            <div class="max-w-container-max mx-auto px-margin-desktop">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-gutter">
                    ...
                    <div
                        ...
                        <p class="font-body-md text-body-md text-on-surface-variant mb-6">Master the fundamental
                            concepts
                    ...
                    <div
                        ...
                        <p class="font-body-md text-body-md text-on-surface-variant mb-6">Upcoming tournaments, trials,
                            and
            ...
            <div class="max-w-container-max mx-auto px-margin-desktop">
                <div class="flex justify-between items-end mb-16">
                    <div class="max-w-xl">
                        ...
                        <p class="font-body-lg text-body-lg text-on-surface-variant">Leading the growth of Indian
                            baseball
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-gutter">
                    ...
                    <div class="group">
                        ...
                        <div class="text-center">
                            ...
                            <p
                                class="font-label-lg text-label-lg text-secondary uppercase font-bold tracking-widest mt-1">
                                President ABFI</p>
                        </div>
                    </div>
                    <!-- Member 2 -->
