...
import { edit, index, update } from "@/routes/players";
...
export default function PlayerEdit({ player, states, organizations, selected_positions,
    ...
    useSetBreadcrumbs([
        ...
        { title: `Edit : ${player?.player_code}`, href: edit({ player: player?.id }).url },
    ...
    return (
        <>
            <PageHeader title="Edit Player" subText="Complete the official registration form to add a player to the national federation database">
