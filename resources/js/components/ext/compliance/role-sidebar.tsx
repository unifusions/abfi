...
export default function RoleSidebar({ roles }) {
    return (
        <div className="w-80 flex-shrink-0 bg-surface-container-low flex flex-col border-r border-outline-variant/15">
            ...
            <div className="flex-1 overflow-y-auto scrollbar-hide px-3 pb-6 space-y-1">
                {/* <!-- Role Card: Active --> */}
                {roles.length > 0 && roles.map((role) => <div key={role.id} className="p-4   bg-zinc-50 shadow-sm border-l-4 border-secondary cursor-pointer transition-all">
